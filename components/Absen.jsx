    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex justify-center items-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md text-center items-center">
          <img src="/assets/image/error.png" alt="error icon" className="h-20 mx-auto mb-4 motion-safe:animate-pulse hover:animate-none"/>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Akses Ditolak</h2>
          <p className="text-gray-600 mb-4">
            Anda belum dapat mengisi daftar hadir karena status akun Anda masih dalam tinjauan. 
          ...
          {!locationRequested ? (
            ...
            <div className="mb-6">
              <div className="mb-4 p-3 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-lg">
                ...
                <p>Akurasi saat ini: {accuracy ? Math.round(accuracy) : "?"} meter (target: {MINIMUM_ACCURACY} meter)</p>
            ...
            <div className="mb-4 p-3 bg-red-50 text-red-700 border border-red-200 rounded-lg">
              Tidak bisa mendapatkan lokasi. Harap izinkan akses lokasi dan coba lagi.
            </div>
          )}
        </div>
      </div>
