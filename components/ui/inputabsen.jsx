...
export default function InputAbsen({type, name, label, placeholder, value, required, readonly, note, minLength, onChange}){
        ...
        return (
            <div className="relative w-full mb-5">
                ...
                <input 
                    ...
                    minLength={minLength}
                    className={cn(
                        "block w-full p-3 text-gray-900 border border-gray-200 rounded-lg bg-white text-base",
                        "focus:ring-blue-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-opacity-50",
            ...
            <div className="relative w-full mb-5">
                ...
                <textarea 
                    ...
                    className={cn(
                        "block w-full p-3 text-gray-900 border border-gray-200 rounded-lg bg-white text-base",
                        "focus:ring-blue-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-opacity-50",
                        "transition-all duration-200 ease-in-out shadow-sm resize-vertical",
                        readonly && "bg-gray-50 cursor-not-allowed opacity-75",
                        error && "border-red-500 focus:ring-red-500 focus:border-red-500"
                    )}
                ></textarea>
