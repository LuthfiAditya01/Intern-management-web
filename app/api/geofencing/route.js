...
export async function GET(request) {
    try {
        ...
        const geofenceSetting = await GeofenceLocation.findOne({
...
export async function POST(request) {
    try {
        ...
        // Buat pengaturan geofencing baru
        const newGeofenceSetting = await GeofenceLocation.create({
...
export async function PUT(request) {
    try {
        ...
        const existingGeofence = await GeofenceLocation.findOne({
            order: [['updatedAt', 'DESC']]
        });
