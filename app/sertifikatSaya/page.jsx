      ...
      try {
        ...
        const unsubscribe = onAuthStateChanged(auth, async (user) => {
          if (user) {
            ...
            const myInternData = data.interns.find(intern => intern.userId === user.uid);
            ...
            if (myInternData && myInternData.isSertifikatVerified) {
              ...
              console.log("Sertifikat belum diverifikasi atau data tidak ditemukan");
            }
          }
          setLoading(false);
        });
  ...
  const generateCertificate = async (internData) => {
    try {
      ...
      if (Array.isArray(templates) && templates.length > 0) {
        ...
        const tanggalMulaiFormatted = formatTanggalIndonesia(internData.tanggalMulai);
        const tanggalSelesaiFormatted = formatTanggalIndonesia(internData.tanggalSelesai);
        ...
        const lamaMagang = calculateDuration(internData.tanggalMulai, internData.tanggalSelesai);
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Sertifikat Magang</h1>
          <button
            onClick={() => window.history.back()}
        ...
        <div className="mb-6">
          <div ref={sertifikatRef} className={`print-container ${styles.printWrapper}`} style={{margin: '0 auto'}}>
